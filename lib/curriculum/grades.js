...
const normalizeModuleBreakdownShape = (moduleSummary) => {
  ...
  return {
    ...
    quiz: {
      ...
      gradingStatus: quizObject?.gradingStatus ?? quizObject?.grading_status ?? moduleSummary?.quizGradingStatus ?? moduleSummary?.quiz_grading_status ?? null,
    },
    ...
    writtenAssignment: {
      ...
      question1Score: numberOrNull(writtenObject?.question1Score ?? writtenObject?.question_1_score ?? moduleSummary?.written_q1_score),
      question2Score: numberOrNull(writtenObject?.question2Score ?? writtenObject?.question_2_score ?? moduleSummary?.written_q2_score),
      gradingStatus: writtenObject?.gradingStatus ?? writtenObject?.grading_status ?? moduleSummary?.writtenGradingStatus ?? moduleSummary?.written_grading_status ?? null,
    },
    written_assignment: {
      ...writtenObject,
      totalScore: writtenAssignment,
    ...
    tradeParticipation: {
      ...
      gradingStatus: tradingObject?.gradingStatus ?? tradingObject?.grading_status ?? moduleSummary?.tradeGradingStatus ?? moduleSummary?.trade_grading_status ?? null,
    },
    trade_participation: {
      ...tradingObject,
      tradePoints: tradeParticipation,
